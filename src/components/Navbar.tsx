...
interface NavbarProps {
  // When set, the language button links to the other language's URL instead
  // of just flipping state (used by the blog, where each language has its own page).
  langSwitchHref?: { es: string; en: string };
}

const Navbar = ({ langSwitchHref }: NavbarProps = {}) => {
    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between h-18 py-3">
        ...
        <div className="hidden md:flex items-center gap-7">
          ...
          {langSwitchHref ? (
            <Link
              to={lang === 'es' ? langSwitchHref.en : langSwitchHref.es}
